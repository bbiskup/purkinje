# -*- coding: utf-8 -*-
# # purkinje documentation build configuration file, created by
# sphinx-quickstart on Sat Dec 20 20:34:55 2014.
...
latex_documents = [
    ('index', 'purkinje.tex', u'purkinje Documentation',
     u'Author', 'manual'),
]
...
man_pages = [
    ('index', 'purkinje', u'purkinje Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
    ('index', 'purkinje', u'purkinje Documentation',
     u'Author', 'purkinje', 'One line description of project.',
     'Miscellaneous'),
]
...
# pub_tocscope = 'default'

# Fix unsupported image types using the PIL.
# pub_fix_images = False

# Scale large images.
# pub_max_image_width = 0

# How to display URL addresses: 'footnote', 'no', or 'inline'.
# pub_show_urls = 'inline'
